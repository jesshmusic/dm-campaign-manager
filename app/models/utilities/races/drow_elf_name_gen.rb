class DrowElfNameGen
  class << self
    ...
    def get_male_name
      ...
      while is_curse
        if rand < 0.5
          name = NAME_MRF.sample + NAME_MRL.sample
        else
          if random_name < 0.65
            name = NAME_MFF.sample + NAME_MFL.sample
          else
            name = NAME_M.sample
          end
        end
    ...
    def get_female_name
      ...
      while is_curse
        if rand < 0.5
          name = NAME_FRF.sample + NAME_FRL.sample
        else
          if random_name < 0.65
            name = NAME_FFF.sample + NAME_FFL.sample
          else
            name = NAME_F.sample
          end
        end
    ...
    def get_surname
      ...
      while is_curse
        if rand < 0.35
          name = NAME_SRF.sample + NAME_SRL.sample
        else
          if random_name < 0.65
            name = NAME_SFF.sample + NAME_SFL.sample
          else
            name = NAME_S.sample
          end
        end
