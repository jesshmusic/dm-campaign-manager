...
export default reduxApi({
  ...
  createNonPlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/non_player_characters/',
    options () {
      const headers = getHeaders();
      return {
        method: 'post',
  ...
  updateNonPlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/non_player_characters/:slug',
    options () {
      const headers = getHeaders();
      return {
        method: 'put',
  ...
  getNonPlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/non_player_characters/:slug.json',
  },
  newNonPlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/non_player_characters/new.json',
  },
  getNonPlayerCharacters: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/non_player_characters.json',
  },
  createPlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/player_characters/',
    options () {
      const headers = getHeaders();
      return {
        method: 'post',
  ...
  updatePlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/player_characters/:slug',
    options () {
      const headers = getHeaders();
      return {
        method: 'put',
  ...
  getPlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/player_characters/:slug.json',
  },
  newPlayerCharacter: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/player_characters/new.json',
  },
  getPlayerCharacters: {
    url: '/v1/campaigns/:campaign_slug/guilds/:guild_slug/player_characters.json',
  },
  getDndClass: {
