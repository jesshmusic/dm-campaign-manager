                      ...
                      {charClass.spellsCantrips && charClass.spellsCantrips.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="0">
                            <Card.Body>
                              {charClass.spellsCantrips.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                        </Card>
                      ...
                      {charClass.spellsLevel1 && charClass.spellsLevel1.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="1">
                            <Card.Body>
                              {charClass.spellsLevel1.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel2 && charClass.spellsLevel2.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="2">
                            <Card.Body>
                              {charClass.spellsLevel2.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel3 && charClass.spellsLevel3.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="3">
                            <Card.Body>
                              {charClass.spellsLevel3.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel4 && charClass.spellsLevel4.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="4">
                            <Card.Body>
                              {charClass.spellsLevel4.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel5 && charClass.spellsLevel5.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="5">
                            <Card.Body>
                              {charClass.spellsLevel5.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel6 && charClass.spellsLevel6.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="6">
                            <Card.Body>
                              {charClass.spellsLevel6.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel7 && charClass.spellsLevel7.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="7">
                            <Card.Body>
                              {charClass.spellsLevel7.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel8 && charClass.spellsLevel8.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="8">
                            <Card.Body>
                              {charClass.spellsLevel8.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
                      ...
                      {charClass.spellsLevel9 && charClass.spellsLevel9.length > 0 ? (
                        <Card>
                          ...
                          <Accordion.Collapse eventKey="9">
                            <Card.Body>
                              {charClass.spellsLevel9.map((spell) => (
                                <p key={spell.value}><strong>{spell.label}</strong></p>
                              ))}
                            </Card.Body>
                          </Accordion.Collapse>
