...
const Home = (props) => (
  <Provider store={store(props)}>
    <Router>
      ...
      <PlayerCharacter path='/app/campaigns/:campaignSlug/guilds/:guildSlug/pcs/:pcSlug' />
      <NonPlayerCharacter path='/app/campaigns/:campaignSlug/guilds/:guildSlug/npcs/:npcSlug' />
      <PlayerCharacterEditor path='/app/campaigns/:campaignSlug/guilds/:guildSlug/pcs/:pcSlug/edit'/>
      <PlayerCharacterEditor path='/app/campaigns/:campaignSlug/guilds/:guildSlug/pcs/new' />
      <NonPlayerCharacterEditor path='/app/campaigns/:campaignSlug/guilds/:guildSlug/npcs/:npcSlug/edit'/>
      <NonPlayerCharacterEditor path='/app/campaigns/:campaignSlug/guilds/:guildSlug/npcs/new' />
