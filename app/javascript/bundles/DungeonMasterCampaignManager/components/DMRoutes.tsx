  ...
  return (
    <Routes>
      ...
      <Route
        ...
        {...props}
        element={<DndClass {...props} />}
      />
      <Route
        path="/app/classes"
        {...props}
        element={<DndClasses {...props} />}
      />
      ...
      <Route
        path="/app/conditions"
        {...props}
        element={<Conditions {...props} />}
      />
      <Route
        path="/app/conditions/:conditionSlug"
        {...props}
        element={<Condition {...props} />}
      />
      ...
      <Route
        ...
        element={<MonsterGenerator {...props} />}
      />
      <Route
        path="/app/admin-dashboard"
        element={
          <ProtectedRoute as={AdminDashboard} requireAdmin={true} {...props} />
        }
      />
      <Route
        path="/app/user-dashboard"
        element={
          <ProtectedRoute as={UserDashboard} requireAdmin={false} {...props} />
        }
      />
      <Route path="*" element={<HomePage {...props} />} />
    </Routes>
